...
class ThirdScreen extends StatelessWidget {
  ...
  final Color ThirdPageColor;

  const ThirdScreen({super.key, required this.titleName, required this.ThirdPageColor});
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text("Counter App", style: TextStyle(fontSize: 30, color: ThirdPageColor),),
